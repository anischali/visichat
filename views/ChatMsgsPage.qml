...
Item {
    ...
    property list<var> msgsList: []

    signal messageRecv(string msg)

    function addMessage(m, r) {
    ...
    onMessageRecv: m => addMessage(m, true)
        ...
        RowLayout {
            ...
            RowLayout {
                ...
                RoundButton {
                    ...
                    onClicked: {
                        addMessage(msgInput.text, false)
                        msgInput.text = ""
                    }
                }
            }
